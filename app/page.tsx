...
import { Briefcase, CheckCircle2, LogInIcon, TrendingUp } from "lucide-react";
      ...
      <main className="flex-1">
        ...
        <section className="container mx-auto px-4 py-32">
          <div className="mx-auto max-w-4xl items-center flex flex-col text-center">
            ...
            <p className="text-mauve-500 mb-10 text-xl">
              Capture organize and manage your job seatch at one place
            </p>
